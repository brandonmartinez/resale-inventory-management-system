...
const Inventory = () => {
	...
	const HeaderColumn = ({ children, ...rest }) => (
		<th
			scope='col'
	...
	const DataColumn = ({ children, ...rest }) => (
		<td className='px-6 py-4 whitespace-nowrap text-sm text-gray-900' {...rest}>
			{children}
		</td>
	);
							...
							<table className='min-w-full divide-y divide-gray-200'>
								<thead className='bg-gray-50'>
									<tr>
										...
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'name')}
										>
											Name
										</HeaderColumn>
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'category')}
										>
											Category
										</HeaderColumn>
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'brand')}
										>
											Brand
										</HeaderColumn>
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'condition')}
										>
											Condition
										</HeaderColumn>
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'cost')}
										>
											Cost
										</HeaderColumn>
										<HeaderColumn
											onClick={() => setColumnOrdering(orderBy, 'price')}
										>
											Price
										</HeaderColumn>
									</tr>
